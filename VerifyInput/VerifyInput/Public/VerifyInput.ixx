...
std::unique_ptr<VerifyInput::List> list_uptr { std::make_unique<VerifyInput::List> ( ) };
...
auto VerifyInput::Validate::ToString ( ) noexcept -> const decltype( value_ )
{
	return value_;
}